...
public class Bestias4Procedure {
    /*
    ...
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
        ...
        if (itemStack3.getItem() == PetsModItems.COSTILLASDETORODESANGRE.get()) {
            ...
            if (itemStack4.getItem() == PetsModItems.CUCARACHADEJARDIN3.get()) {
                Level _level2;
                Player _player2;
                if (entity instanceof Player) {
                    _player2 = (Player)entity;
                    ItemStack _stktoremove = new ItemStack((ItemLike)PetsModItems.COSTILLASDETORODESANGRE.get());
// TODO: Fix clearOrCountMatchingItems signature
        //                     _player2.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 5);
                }
...
_level2.playLocalSound(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.cat.eat")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                ...
                PetsMod.queueServerWork(60, () -> {
                    ItemStack _ist;
                    ServerLevel _level3;
                    if (world instanceof ServerLevel) {
                        // _level = (ServerLevel)world; // Commented - lambda issue
//                         ((ServerLevel)_level).getServer().getCommands().performCommand(_level.getServer().createCommandSourceStack().withSuppressedOutput(), "give @p pets:alimentopotenciadodemosutros 1");
                    }
                    if (world instanceof ServerLevel) {
                        // _level = (ServerLevel)world; // Commented - lambda issue
                        // Command execution disabled - needs reimplementation
                    }
                    if ((_ist = itemstack).hurt(50, world.getRandom(), null)) {
                        _ist.setCount(1);
        ...
        if (itemStack2.getItem() != PetsModItems.YOKAICAN.get()) return;
        if (entity instanceof LivingEntity) {
            LivingEntity _livEnt = (LivingEntity)entity;
        ...
        if (itemStack.getItem() != PetsModItems.CUCARACHADEJARDIN3.get()) return;
        if (entity instanceof Player) {
            _player = (Player)entity;
            ItemStack _stktoremove = new ItemStack((ItemLike)PetsModItems.YOKAICAN.get());
// TODO: Fix clearOrCountMatchingItems signature
        ...
        if (world instanceof Level && !(_level = (Level)world).isClientSide) {
            _level.addFreshEntity((Entity)new ExperienceOrb(_level, x, y, z, 10));
        }
        PetsMod.queueServerWork(40, () -> {
