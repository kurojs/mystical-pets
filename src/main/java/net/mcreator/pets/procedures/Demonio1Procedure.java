...
public class Demonio1Procedure {
    /*
    ...
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
        ...
        if (itemStack3.getItem() == Items.NETHER_STAR) {
            ...
            if (itemStack4.getItem() == PetsModItems.MIRADADEBRASA.get()) {
                Level _level2;
                Player _player2;
...
//                         ((ServerLevel)_level).getServer().getCommands().performCommand(_level.getServer().createCommandSourceStack().withSuppressedOutput(), "give @p:pets 1");
                    }
                    if (world instanceof ServerLevel) {
                        // _level = (ServerLevel)world; // Commented - lambda issue
        ...
        if (itemStack.getItem() != PetsModItems.MIRADADEBRASA.get()) return;
        if (entity instanceof Player) {
