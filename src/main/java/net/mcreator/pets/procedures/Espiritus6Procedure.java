...
public class Espiritus6Procedure {
    /*
    ...
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
        ...
        if (itemStack3.getItem() == PetsModItems.UINIONDEELEMENTOS.get()) {
            ...
            if (itemStack4.getItem() == PetsModItems.SAPOLLORON.get()) {
                Level _level2;
                Player _player2;
                if (entity instanceof Player) {
                    _player2 = (Player)entity;
                    ItemStack _stktoremove = new ItemStack((ItemLike)PetsModItems.UINIONDEELEMENTOS.get());
// TODO: Fix clearOrCountMatchingItems signature
        //                     _player2.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 3);
                }
...
//                         ((ServerLevel)_level).getServer().getCommands().performCommand(_level.getServer().createCommandSourceStack().withSuppressedOutput(), "give @p pets:mejoradordeespirtu 1");
                    }
                    if (world instanceof ServerLevel) {
                        // _level = (ServerLevel)world; // Commented - lambda issue
        ...
        if (itemStack2.getItem() != PetsModItems.ESPIRITUENSALADAFRESCA.get()) return;
        if (entity instanceof LivingEntity) {
            LivingEntity _livEnt = (LivingEntity)entity;
        ...
        if (itemStack.getItem() != PetsModItems.SAPOLLORON.get()) return;
        if (entity instanceof Player) {
            _player = (Player)entity;
            ItemStack _stktoremove = new ItemStack((ItemLike)PetsModItems.ESPIRITUENSALADAFRESCA.get());
// TODO: Fix clearOrCountMatchingItems signature
