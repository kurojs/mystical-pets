...
public class Goblin4Procedure {
    ...
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
        ...
        if (itemStack3.getItem() == Items.GLOW_BERRIES) {
            ...
            if (itemStack4.getItem() == PetsModItems.ADONAYELMILRAZAS.get()) {
                Level _level2;
                Player _player2;
                if (entity instanceof Player) {
                    _player2 = (Player)entity;
                    ItemStack _stktoremove = new ItemStack((ItemLike)Items.GLOW_BERRIES);
// TODO: Fix clearOrCountMatchingItems signature
        //                     _player2.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 30);
                }
...
//                         ((ServerLevel)_level).getServer().getCommands().performCommand(_level.getServer().createCommandSourceStack().withSuppressedOutput(), "give @p pets:goblinmejorad 1");
                    }
                    if (world instanceof ServerLevel) {
                        // _level = (ServerLevel)world; // Commented - lambda issue
        ...
        if (itemStack2.getItem() != PetsModItems.CARNEDERES.get()) return;
        if (entity instanceof LivingEntity) {
            LivingEntity _livEnt = (LivingEntity)entity;
        ...
        if (itemStack.getItem() != PetsModItems.ADONAYELMILRAZAS.get()) return;
        if (entity instanceof Player) {
            _player = (Player)entity;
            ItemStack _stktoremove = new ItemStack((ItemLike)PetsModItems.CARNEDERES.get());
// TODO: Fix clearOrCountMatchingItems signature
