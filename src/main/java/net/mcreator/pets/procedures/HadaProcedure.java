...
public class HadaProcedure {
    ...
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
        ...
        if (itemStack3.getItem() == Items.GLOW_BERRIES) {
            ...
            if (itemStack4.getItem() == PetsModItems.HADAAMARILLA.get()) {
                Level _level2;
                Player _player2;
...
//                         ((ServerLevel)_level).getServer().getCommands().performCommand(_level.getServer().createCommandSourceStack().withSuppressedOutput(), "give @p pets:hadas 1");
                    }
                    if (world instanceof ServerLevel) {
                        // _level = (ServerLevel)world; // Commented - lambda issue
        ...
        if (itemStack2.getItem() != PetsModItems.GALLETADEUWU.get()) return;
        if (entity instanceof LivingEntity) {
            LivingEntity _livEnt = (LivingEntity)entity;
        ...
        if (itemStack.getItem() != PetsModItems.HADAAMARILLA.get()) return;
        if (entity instanceof Player) {
            _player = (Player)entity;
            ItemStack _stktoremove = new ItemStack((ItemLike)PetsModItems.GALLETADEUWU.get());
// TODO: Fix clearOrCountMatchingItems signature
