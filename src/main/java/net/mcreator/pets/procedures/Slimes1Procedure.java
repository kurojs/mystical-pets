...
public class Slimes1Procedure {
    ...
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
        ...
        if (itemStack3.getItem() == Items.SLIME_BALL) {
            ...
            if (itemStack4.getItem() == PetsModItems.SLIMEACIDO.get()) {
                Level _level2;
                Player _player2;
                if (entity instanceof Player) {
                    _player2 = (Player)entity;
                    ItemStack _stktoremove = new ItemStack((ItemLike)Items.SLIME_BALL);
...
//                         ((ServerLevel)_level).getServer().getCommands().performCommand(_level.getServer().createCommandSourceStack().withSuppressedOutput(), "give @p pets:fgdfg 1");
                    }
                    if (world instanceof ServerLevel) {
                        // _level = (ServerLevel)world; // Commented - lambda issue
        ...
        if (itemStack2.getItem() != PetsModItems.BOLITADECARNE.get()) return;
        if (entity instanceof LivingEntity) {
            LivingEntity _livEnt = (LivingEntity)entity;
        ...
        if (itemStack.getItem() != PetsModItems.SLIMEACIDO.get()) return;
        if (entity instanceof Player) {
            _player = (Player)entity;
            ItemStack _stktoremove = new ItemStack((ItemLike)PetsModItems.BOLITADECARNE.get());
// TODO: Fix clearOrCountMatchingItems signature
